                ...
                <div class="col-lg-12">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-list-answer">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Tao cũng <strong>không</strong> biết nữa</td>
                                        <td>100</td>
                                        <td><i style="font-size: 40px; color: blue;" class="fa fa-check"></i></td>
                                        <td>Thanh Tùng</td>
                                        ...
                                        <td><a href="/admin/answer/edit"><i style="font-size: 40px;" class="fa fa-edit"></i></a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Tao cũng <strong>không</strong> biết nữa</td>
                                        <td>100</td>
                                        <td><i style="font-size: 40px; color: gray;" class="fa fa-minus"></i></td>
                                        <td>Thanh Tùng</td>
                                        <td>30/09/2017 22:00:00</td>
                                        <td>30/09/2017 22:00:00</td>
                                        <td>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3><small>Các bình luận của câu trả lời:</small> ID: 1</h3>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
