			...
			<div class="col-lg-5 break-word" style="margin-right: 20px;">
				...
				<div calss="a">
					...
					<div class="user_active">
						...
						<p><a href="{{ route('detail-question', ['question_id'=>$qs->id, 'question_url'=>$qs->title_url]) }}">{{ $qs->title }}</a></p>
				...
				<div>
					...
					<div class="user_active">
						...
						<p><a href="{{ route('detail-question', ['question_id'=>$answer->question->id, 'question_url'=>$answer->question->title_url]) }}">{{ $answer->question->title }}</a></p>
			...
			<div class="col-lg-6 break-word" style="margin-left: 20px;">
				...
				<div>
					...
					<div class="user_active">
						...
						<p><a href="{{ route('detail-documentation', ['documentation_id'=>$documentation->id, 'documentation_url'=>$documentation->title_url]) }}">{{ $documentation->title }}</a></p>
